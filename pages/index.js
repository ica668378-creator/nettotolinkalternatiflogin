...
const D = {
  brand: 'NETTOTO',
  domain: 'nettotolinkalternatiflogin.com',
  ...
  amphtml: 'nettotolinkalternatiflogin.com',
};
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>NETTOTO - Link Alternatif Tercepat: Akses Langsung ke Arena Kemenangan</title>
        <meta name="description" content="Akses NETTOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="NETTOTO - Link Alternatif Tercepat: Akses Langsung ke Arena Kemenangan" />
        <meta property="og:description" content="Akses NETTOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="NETTOTO - Link Alternatif Tercepat: Akses Langsung ke Arena Kemenangan" />
        <meta name="twitter:description" content="Akses NETTOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
      ...
      <style jsx global>{`
        :root{--bg:#fffdf5;--bg2:#fff8e1;--card:#fff;--primary:#f57c00;--primary2:#e65100;--accent:#ffb74d;--text:#3e2723;--muted:#795548;--border:rgba(245,124,0,.08);--r:20px}
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        ...
        header{position:sticky;top:0;z-index:50;background:#fffdf5f0;backdrop-filter:blur(14px);border-bottom:1px solid var(--border)}
        ...
        .bp{background:var(--primary);color:#fff;box-shadow:0 4px 16px #f57c0035}
        .bp:hover{background:var(--primary2);transform:translateY(-2px);box-shadow:0 6px 24px #f57c0050}
        ...
        .badge{display:inline-flex;align-items:center;gap:8px;padding:6px 16px;border:1px solid var(--border);border-radius:99px;font-size:12px;color:var(--primary);background:#f57c0010;margin-bottom:20px;font-weight:600}
        ...
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px #f57c0020}
        ...
        .sh .tg{display:inline-block;padding:5px 14px;border:1px solid var(--border);border-radius:var(--r);font-size:11px;color:var(--primary);background:#f57c0008;margin-bottom:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px}
        ...
        .fc:hover{transform:translateY(-4px);border-color:var(--primary);box-shadow:0 10px 30px #f57c0015}
        .fc .ic{width:48px;height:48px;border-radius:var(--r);background:#f57c0012;display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:12px}
        ...
        .cta .b{background:#fffdf5;color:var(--primary)}
        ...
        .hero{background:linear-gradient(135deg,#fff8e1,#ffe0b2)}.fc{border-radius:20px;box-shadow:0 4px 20px rgba(245,124,0,.06)}.step .nm{border-radius:20px}.badge{border-radius:20px;font-weight:800}
      `}</style>
      ...
      <main>
        <section className="hero"><div className="C">
          ...
          <h1>NETTOTO - Link Alternatif Tercepat: Akses Langsung ke Arena Kemenangan</h1>
        ...
        <section className="bnr"><div className="C">
          <div className="bnr-grid">
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1523050854058-8df90110c476?w=720&h=280&fit=crop" alt="NETTOTO - Promo 1" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=720&h=280&fit=crop" alt="NETTOTO - Promo 2" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1509062522246-3755977927d7?w=720&h=280&fit=crop" alt="NETTOTO - Promo 3" loading="lazy" /></a>
          </div>
        </div></section>
        <section className="sec"><div className="C">
          <div className="sg">
        ...
        <section className="sec" id="tentang"><div className="C">
          ...
          <div className="art">
            <p>NETTOTO hadir di situs resmi NETTOTO sebagai platform digital yang mengedepankan kemudahan dan keamanan akses bagi seluruh pengguna. Seperti lembaga pendidikan yang membuka pintu ilmu pengetahuan, NETTOTO membuka akses login dan registrasi yang mudah dipahami oleh siapa saja. Proses pendaftaran hanya membutuhkan waktu kurang dari 2 menit dengan panduan yang jelas di setiap langkahnya.</p>
            <p>Di situs resmi NETTOTO, NETTOTO menyediakan lingkungan digital yang aman dan terproteksi. Enkripsi SSL 256-bit menjaga kerahasiaan data pengguna, sementara server berkapasitas tinggi menjamin loading cepat tanpa hambatan. Dukungan multi-platform memungkinkan akses dari Android, iOS, Windows, maupun berbagai browser populer. Tim support yang ramah dan profesional siap membantu Anda 24 jam nonstop.</p>
          </div>
        </div></section>
